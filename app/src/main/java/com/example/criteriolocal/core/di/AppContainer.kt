...
class DefaultAppContainer(context: Context) : AppContainer {
    ...
    override val ratingRegistrationManager: RatingRegistrationManager by lazy {
    ...
    override val businessMetricsManager: BusinessMetricsManager by lazy {
    ...
    override val frontendContractManager: FrontendContractManager by lazy {
        FrontendContractManager(
